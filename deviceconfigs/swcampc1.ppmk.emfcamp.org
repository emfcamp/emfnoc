...
!Motherboard serial number       : CAT08410A2P
!Motherboard revision number     : A0
!Power supply part number        : 341-0029-03
!Power supply serial number      : LIT083802SH
!
!Processor ID: CAT0841K0HK
!
...
!
interface Loopback0
 ip address 94.45.227.20 255.255.255.255
 ip ospf 1 area 0
 ipv6 address 2001:67C:20A1:FFFF::20/128
 ipv6 ospf 1 area 0
!
...
interface GigabitEthernet1/0/1
 description To_SWCAMPB1.PPMK_Gi1/0/2
 no switchport
 ip address 94.45.226.98 255.255.255.252
 ip pim sparse-mode
 ip ospf 1 area 0
 ipv6 address 2001:67C:20A1:EEEE:25::98/112
 ipv6 ospf 1 area 0
!
interface GigabitEthernet1/0/2
 description To_SWCAMPD1.PPMK_Gi1/0/1
 no switchport
 ip address 94.45.226.101 255.255.255.252
 ip pim sparse-mode
 ip ospf 1 area 0
 ipv6 address 2001:67C:20A1:EEEE:26::101/112
 ipv6 ospf 1 area 0
!
...
!
interface Vlan1
 ip address 94.45.237.1 255.255.255.0
 ip helper-address 94.45.224.196
 ip pim sparse-mode
 ipv6 address FE80::1 link-local
 ipv6 address 2001:67C:20A1:237::1/64
